...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            #navMenu button {
                width: 95vw; /* Prend toute la largeur sur les petits écrans */
            }
        }
    ...
    <div class="container mt-1" >
         <div class="d-flex align-items-start" >
            <div id="navMenu" class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-statics" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                        Tableau de Bord 
                </button>
            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-statics" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                        <div  id="menu_tabStatic">
