        ...
        <div class="container mt-1" >
            <div class="d-flex align-items-start" >
                    <div class="col-3">
                        ...
                        <a class="nav-link  " href="../PrestationService/PrestationServices.php" id="">
                                Prestation Digital
                        </a>
                        <a class="nav-link  " href="../Formation/formations.php" id="">
                                Formations
                        </a>
                        <a class="nav-link  " href="../Vente/ventes.php" id="">
                                Vente
                        </a>
                ...
                <div class="col-9">
                        <div id="menu_tab">
                            ...
                            <div class="row">
                                   <h3>Bienvenue a la page distribution internet</h3>
                            </div>
                        </div>
                </div>
            </div>
